...
if ! grep -q "HiddenMenu" "$WORK_DIR/vendor/etc/init/init.s5e8825.rc"; then
    APPLY_VENDOR_PATCH "etc/init" "0001-Create-carrier-folder-for-HiddenMenu.patch"
fi
APPLY_VENDOR_PATCH "etc/init" "0002-Optimize-for-faster-boot-time.patch"
APPLY_VENDOR_PATCH "etc/init" "0003-Disable-UFS-Power-Saving-on-Init.patch"
APPLY_VENDOR_PATCH "etc/init" "0004-Move-Foreground-CPUSET-to-small-cores.patch"
APPLY_VENDOR_PATCH "etc/init" "0005-Move-Background-CPUSET-to-Cores-0-1.patch"
APPLY_VENDOR_PATCH "etc/init" "0006-Move-SF-CPUSET-to-big-cores.patch"
APPLY_VENDOR_PATCH "etc/init" "0007-Restrict-apps-access-to-proc-net-unix.patch"
